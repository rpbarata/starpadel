...
Trestle.configure do |config|
  ...
  #
  config.site_logo = "logo_staff.png"
  ...
  #
  config.footer = "Powered by MEI-DEI Group"
  ...
  #     item "Custom Link", "/admin/custom", icon: "fa fa-car", badge: { text: "NEW!", class: "label-success" },
  #       priority: :first
  #   end
  # end
